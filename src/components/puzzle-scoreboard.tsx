...
const PuzzleScoreboard: React.FC = () => {
  ...
  // Add this new function to check if the selected date is in February
  const isFebruaryEntry = (date: string) => {
  ...
  const handleDateChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Show warning if date is not today and not in February
    setShowPastDateWarning(selectedDate !== today && !isFebruaryEntry(selectedDate));
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      ...
      <div className="p-6">
              ...
              <div className="space-y-2">
                ...
                {showPastDateWarning && (
                  <div className="text-amber-600 text-sm">
                    Warning: You are entering scores for a past date that is not in February
                  </div>
                )}
              </div>
        ...
        {/* Archive Links - Add this section */}
        <ArchiveLinks />
